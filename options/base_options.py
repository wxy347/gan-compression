...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='training/cycleGan/checkpoints', help='models are saved here')
        # model parameters
        ...
        parser.add_argument('--netG', type=str, default='resnet_2blocks', help='specify generator architecture [resnet_9blocks | resnet_6blocks | resnet_3blocks | unet_256 | unet_128]')
